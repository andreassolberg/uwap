...
?>
    ...
    <fieldset id="actions">
        <p><input checked="checked" type="checkbox" id="message" value="">
        	<label for="message">Allow this application to <strong>send me email message</strong> upto once a week. Even if you allow this, the application will not be able to see your email address.</label>
    </fieldset>
