...
if ($id === 'auth') {
	$hostname = 'auth.' . GlobalConfig::hostname();
} else {
...
$statichost = Utils::getScheme() . '://static.' . GlobalConfig::hostname();
$corengine = Utils::getScheme() . '://auth.' . GlobalConfig::hostname();
...
requirejs.config({
	paths: {
		...
		'uwap-core' : '<?php echo $statichost; ?>',
		'uwap-core/bootstrap3/js/bootstrap3': '<?php echo $statichost; ?>/bootstrap3/js/bootstrap.min',
		// 'text'		: '<?php echo $statichost; ?>/_/js/text',
		'uwap': '/_/js',
	},
